...
function mayorACien(array) {
  //La función recibe un array con enteros entre 0 y 200. Recorrer el array y guardar en 
  // un nuevo array sólo los
...
function continueStatement(numero) {
  ...
  Guardar cada nuevo valor en un array.    
  Devolver el array
  Cuando el número de iteraciones alcance el valor 5, no se suma en ese caso y
